...
"""
Default configuration module for BP-Tracer.

Structured to mirror config_conda.py with English comments and grouped settings.
Tool paths now point to the fixed BP-Tracer bin directory rather than conda
environment tools. All parameter names and meanings are preserved.
"""
...
BP_DIAMOND_SOFTWARE = os.path.join(BIN_PATH, 'Diamond/diamond blastx')
...
BP_USCMG_SOFTWARE = os.path.join(BIN_PATH, 'Diamond/diamond blastx')
